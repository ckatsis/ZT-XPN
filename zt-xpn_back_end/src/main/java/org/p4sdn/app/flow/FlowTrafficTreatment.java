...
import org.onosproject.net.flow.instructions.Instructions.TableTypeTransition;
...
public class FlowTrafficTreatment implements TrafficTreatment {
    ...
    private static final FlowTrafficTreatment EMPTY
            = new FlowTrafficTreatment(ImmutableList.of(Instructions.createNoAction()));
     ...
     */
    private FlowTrafficTreatment(List<Instruction> immediate) {
     ...
     */
    private FlowTrafficTreatment(List<Instruction> deferred,
    ...
    @Override
    public TableTypeTransition tableTransition() {
        return table;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FlowTrafficTreatment) {
            FlowTrafficTreatment that = (FlowTrafficTreatment) obj;
    ...
    public static final class Builder implements TrafficTreatment.Builder {
        ...
        public Builder add(Instruction instruction) {
            ...
            if (instruction instanceof ExtendedInstruction) {
                ...
                switch (ei.extendedType()) {
                    case STATEFUL_PROCESSING:
        ...
        public TrafficTreatment build() {
            ...
            return new FlowTrafficTreatment(deferred, immediate, table, clear, meta, meter, statTrigger);
        }

        // Added methods
        public TrafficTreatment.Builder statefulProcessing(boolean keepState, int stateId, boolean isDependent, int dependencyStateId, 
                long outputPort) {
            return add(createStatefulProcessing(keepState, stateId, isDependent, dependencyStateId, outputPort));
        }

        // public TrafficTreatment.Builder setStateId(int stateId) {
        //     return add(createStateId(stateId));
        // }

        public static StatefulProcessingInstruction createStatefulProcessing(
                boolean keepState, int stateId, boolean isDependent, 
                int dependencyStateId, long outputPort) {
            return new StatefulProcessingInstruction(keepState, stateId, isDependent, dependencyStateId, outputPort);
        }

        // public static StateIdInstruction createStateId(int stateId) {
        //     return new StateIdInstruction(stateId);
        // }

        // public static DependencyStateIdInstruction createDependencyStateId(int dependencyStateId) {
        //     return new DependencyStateIdInstruction(dependencyStateId);
        // }

        // public TrafficTreatment.Builder setDependencyStateId(int dependencyStateId) {
        //     return add(createDependencyStateId(dependencyStateId));
        // }
    }
}
